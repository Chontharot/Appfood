...
class _Page6State extends State<Page6> {
  ...
  void _launchYouTube() async {
    final Uri url = Uri.parse(
        'https://youtu.be/aYWI_emW8kk?si=GA_Ta_h1tXZn4iWm'); // ใส่ลิงก์ YouTube
