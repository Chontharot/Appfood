...
class _Page1State extends State<Page1> {
  ...
  void _launchYouTube() async {
    final Uri url = Uri.parse('https://youtu.be/chwvx3YdXfA?si=E5Sly7QWF-Ly5wet'); // ใส่ลิงก์ YouTube
